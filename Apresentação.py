...
Com mais de uma década de experiência na área de tecnologia gráfica, tenho me dedicado a expandir e aprimorar meu conhecimento em Ciência de Dados. Sou formado em Engenharia de Produção e possuo uma pós-graduação em Ciência de Dados, além de uma sólida experiência em programação com Python. Minha jornada inclui o desenvolvimento de aplicativos e soluções para análise e visualização de dados, utilizando ferramentas como Streamlit e Plotly, além de trabalhar com SQL e MySQL para manipulação e análise de grandes volumes de dados.
